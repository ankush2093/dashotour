    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <h1 class="blog_category_title">Secure <span class="uniq_text_span">Payment</span></h1>
                <p class="blog_category_subtitle">
                    Scan the QR code below to complete your payment safely and instantly. Once your payment is confirmed, our team will contact you shortly with the next steps.
                </p>

                <nav aria-label="breadcrumb" class="blog_category_breadcrumb">
                    <ol class="breadcrumb justify-content-center">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <!-- <li class="breadcrumb-item"><a href="blogs.php">Payment</a></li> -->
